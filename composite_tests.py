...
class TestComposite(unittest.TestCase):
    ...
    def test_composite_w_angle(self):
        ...
        actual = composite.solve(strains=(1000, 0, 0), stresses=(None, None, None))
    ...
    def test_composite_w_delta_t(self):
        ...
        actual = composite.solve(strains=(0, 0, 0), stresses=(None, None, None))
    ...
    def test_composite_w_deltas(self):
        ...
        actual = composite.solve(strains=(None, None, None), stresses=(0, 0, 0))
